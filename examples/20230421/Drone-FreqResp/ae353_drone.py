...
class Simulator:
    ...
    def __init__(
        ...
        # activity_t seconds)
        self.check_for_inactivity = True
        self.activity_d = 0.5
        self.activity_t = 5.0
    ...
    def set_rules(self, error_on_print=True, error_on_timeout=True, check_for_inactivity=True):
        self.error_on_print = error_on_print
        self.error_on_timeout = error_on_timeout
        self.check_for_inactivity = check_for_inactivity
